param([string]$OutputDirectory = 'dist-arkboard-1.11.0')
...
$arguments += "/resource:$projectRoot\assets\TestBeeRefV1.bee,ArkBoard.TestBeeRefV1"
$arguments += "/resource:$projectRoot\assets\TestBeeRefV2.bee,ArkBoard.TestBeeRefV2"
