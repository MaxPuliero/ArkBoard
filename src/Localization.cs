...
namespace ArkBoard
{
    ...
    internal static class Localization
    {
        ...
        static readonly Dictionary<string, string[]> Values = new Dictionary<string, string[]>
        {
            ...
            { "Distance between images during packing and snapping, in canvas pixels.", new[]{ "Distance between images during packing and snapping, in canvas pixels.", "Distanza tra le immagini durante compattazione e aggancio, in pixel del canvas.", "整列とスナップ時の画像間隔（キャンバスのピクセル単位）。" } },
