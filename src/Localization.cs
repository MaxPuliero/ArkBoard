...
namespace ArkBoard
{
    ...
    internal static class Localization
    {
        ...
        static readonly Dictionary<string, string[]> Values = new Dictionary<string, string[]>
        {
            ...
            { "Snapping", new[]{ "Snapping", "Aggancio", "スナップ" } },
            { "Snapping enabled", new[]{ "Snapping enabled", "Aggancio attivato", "スナップを有効化" } },
            { "Snapping disabled", new[]{ "Snapping disabled", "Aggancio disattivato", "スナップを無効化" } },
            { "Image Padding", new[]{ "Image Padding", "Spaziatura immagini", "画像の間隔" } },
            { "Enter a value from 0 to 10,000 pixels.", new[]{ "Enter a value from 0 to 10,000 pixels.", "Inserisci un valore da 0 a 10.000 pixel.", "0～10,000ピクセルの値を入力してください。" } },
            { "Invert Zoom", new[]{ "Invert Zoom", "Inverti zoom", "ズームを反転" } },
            { "Auto-Check for Updates", new[]{ "Auto-Check for Updates", "Controllo automatico aggiornamenti", "アップデートを自動確認" } },
            { "Check", new[]{ "Check", "Controlla", "確認" } },
            ...
            { "Update available", new[]{ "Update available", "Aggiornamento disponibile", "アップデートがあります" } },
            { "ArkBoard {0} is available. You are using {1}.", new[]{ "ArkBoard {0} is available. You are using {1}.", "È disponibile ArkBoard {0}. Stai usando la versione {1}.", "ArkBoard {0} を利用できます。現在のバージョンは {1} です。" } },
            { "Checking for updates...", new[]{ "Checking for updates...", "Controllo aggiornamenti...", "アップデートを確認中..." } },
            { "No updates available", new[]{ "No updates available", "Nessun aggiornamento disponibile", "利用可能なアップデートはありません" } },
            { "You are using the latest version of ArkBoard.", new[]{ "You are using the latest version of ArkBoard.", "Stai usando la versione più recente di ArkBoard.", "ArkBoardは最新バージョンです。" } },
            { "Unable to check for updates", new[]{ "Unable to check for updates", "Impossibile controllare gli aggiornamenti", "アップデートを確認できません" } },
            { "Check your internet connection and try again.", new[]{ "Check your internet connection and try again.", "Controlla la connessione Internet e riprova.", "インターネット接続を確認して、もう一度お試しください。" } },
            { "Save ArkBoard update", new[]{ "Save ArkBoard update", "Salva aggiornamento di ArkBoard", "ArkBoardアップデートを保存" } },
            { "Downloading update...", new[]{ "Downloading update...", "Download aggiornamento...", "アップデートをダウンロード中..." } },
            { "Update downloaded", new[]{ "Update downloaded", "Aggiornamento scaricato", "アップデートをダウンロードしました" } },
            { "ArkBoard {0} was saved to:\n{1}", new[]{ "ArkBoard {0} was saved to:\n{1}", "ArkBoard {0} è stato salvato in:\n{1}", "ArkBoard {0} を次の場所に保存しました：\n{1}" } },
            { "Unable to download update", new[]{ "Unable to download update", "Impossibile scaricare l'aggiornamento", "アップデートをダウンロードできません" } },
            { "The release does not contain an ArkBoard download.", new[]{ "The release does not contain an ArkBoard download.", "La release non contiene un download di ArkBoard.", "リリースにArkBoardのダウンロードがありません。" } },
